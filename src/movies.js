// const employee1 = {id: 123, adress: {city: "Lod", country: "Israel"}};
// const employee2 = {id: 123, adress: {city: "Lod", country: "Israel"}};
// const employee1Json = JSON.stringify(employee1);
// const employee2Json = JSON.stringify(employee2);
// console.log(employee1Json);
// // const employee3 = {...employee1}; // узкая копия
// // employee3.id = 124;
// // employee3.adress.city = "Rehovot";
// // // console.log(employee3.id)
// // console.log(employee1.adress.city)
// const employee4 = JSON.parse(employee1Json);
// employee4.adress.city = "Rehovot";
// console.log(employee1.adress.city)
// console.log(employee4.adress.city)
...
function showDetails(index) {
  detailsImageElement.crs=`${httpPrefix}${data.results[index].backdrop_path}`
}
anchorElements.forEach((anchor, index) => anchor.addEventListener("click",function() {
  showDetails(index);
}))
function getAnchors(){
